...
if __name__ == '__main__':
    ...
    #argparse.ArgumentParser(...): Initializes the argument parser with a description.
    #parser.add_argument(...): Defines command-line arguments that the script accepts.
    #args = parser.parse_args(): Parses the command-line arguments and stores them in the args object.
    if not os.path.exists(args.outdir):
        os.mkdir(args.outdir)    # Setting Up Output Directories
    ...
    if args.testDataType == 'sbm_cd':
        print("-------------------")
        # print(args.testDataType)
        
        node_num =1095 #11492# 1095  #!
        # community_num = 2
        ...
        # print("=== Datafile : ") # where data is present
        datafile = input('Enter directory where data is present in adjlist format ')
        print("--------------------------- datafile print ---------------------")
        print(datafile)
        ...
        embedding.learn_embedding()   # ~!!!!!!!!!! Working changes here
        embedding.get_embedding()
        #embedding.plotresults(dynamic_sbm_series)
       # plt.savefig("dynamic_sbm_results.png")
        ...
        if not os.path.exists('./test_data/academic/pickle'):
            ...
            os.makedirs('./test_data/academic/pickle',exist_ok=True)
        ...
        print("--------",graphs)
        # G_cen = nx.degree_centrality(graphs[3])  # graph 29 in academia has highest number of edges
